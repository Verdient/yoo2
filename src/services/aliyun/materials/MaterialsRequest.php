 ...
 * @author Jx.
 */
class MaterialsRequest extends \yoo\base\RESTRequest
{
	/**
	 * @var String $format
	 * 返回数据格式
	...
	protected function _prepareResponse($response){
		return new MaterialsResponse($response);
	}
	...
	public function getTicketId(){
		$cache = Yii::$app->cache;
		return $cache->get($this->getOperatorIdentity() . 'verifyToken');
	}
}